...
func LoadRoutes() *mux.Router {
	...
	router.HandleFunc("/all-contests/contest/{contestName}", get.GetContestDetails)
	...
	router.HandleFunc("/all-contests/contest/{contestName}/scoreboard", post.ScoreBoardHandler)
	...
	router.HandleFunc("/all-contests/contest/{contestName}/problem/{problemName}", get.ProblemHandler)
